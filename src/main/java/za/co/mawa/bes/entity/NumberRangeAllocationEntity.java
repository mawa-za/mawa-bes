...
public class NumberRangeAllocationEntity {
    ...
    protected NumberRangeAllocationEntity() {}

    public NumberRangeAllocationEntity(String deviceId,Integer sequenceNo, long fromNo, long toNo) {

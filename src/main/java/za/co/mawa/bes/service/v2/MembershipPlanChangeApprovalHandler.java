...
public class MembershipPlanChangeApprovalHandler implements ApprovalCompletionHandler {
 private final MembershipChangeService service;
 public ApprovalType supports(){ return ApprovalType.MEMBERSHIP_PLAN_CHANGE; }

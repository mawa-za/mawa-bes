...
public class ClaimService {
    ...
    public ClaimOutboundDto get(String id) {
        try {
            ...
            claimOutboundDto.setStatusReason(fieldOptionService.getFieldOption(Field.CLAIM_DECLINE_REASON, transactionDto.getStatusReason().toUpperCase()));
            //claimOutboundDto.setStatusReason(fieldOptionService.getFieldOption(Field.PAYMENT_REQUEST_STATUS_REASON, transactionDto.getStatusReason().toUpperCase()));

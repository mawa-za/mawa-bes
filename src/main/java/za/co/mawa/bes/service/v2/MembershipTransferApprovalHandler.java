...
public class MembershipTransferApprovalHandler implements ApprovalCompletionHandler {
 private final MembershipChangeService service;
 public ApprovalType supports(){ return ApprovalType.MEMBERSHIP_TRANSFER; }

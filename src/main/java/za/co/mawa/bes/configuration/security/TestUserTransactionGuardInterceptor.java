...
public class TestUserTransactionGuardInterceptor implements HandlerInterceptor {
    ...
    private boolean isPublic(String p){return p==null||p.contains("authenticate")||p.contains("refresh-token")||p.startsWith("/internal/admin/")||p.startsWith("/v2/pos-print-agents/")||p.equals("/v2/admin-handoff/exchange")||p.startsWith("/swagger")||p.startsWith("/v3/api-docs");}
